...
import { useSidebar } from "@/hooks/use-sidebar" // Assuming you have a sidebar context/hook

export function Navbar() {
  const { data: session } = useSession()
  const { toggleSidebar } = useSidebar() // Use the sidebar hook
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                  ...
                  {/* You can add an Avatar component here if you have user images */}
