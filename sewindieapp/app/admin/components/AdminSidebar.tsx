    ...
    <div className="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style={{ height: "100vh" }}>
      ...
      <ul className="nav nav-pills flex-column mb-auto">
        <li className="nav-item">
          <Link
            href="/admin"
            className={`nav-link text-white ${isActive("/admin") && pathname === "/admin" ? "active" : ""}`}
          >
        ...
        {isAdmin && (
          <li>
            <Link href="/admin/users" className={`nav-link text-white ${isActive("/admin/users") ? "active" : ""}`}>
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/designers") ? "active" : ""}`}
          >
        ...
        <li>
          <Link href="/admin/patterns" className={`nav-link text-white ${isActive("/admin/patterns") ? "active" : ""}`}>
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/contributions") ? "active" : ""}`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/analytics") ? "active" : ""}`}
          >
        ...
        <li>
          <Link href="/admin/ratings" className={`nav-link text-white ${isActive("/admin/ratings") ? "active" : ""}`}>
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/categories") ? "active" : ""}`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/audiences") ? "active" : ""}`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/fabric-types") ? "active" : ""}`}
          >
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/suggested-fabrics") ? "active" : ""}`}
          >
        ...
        <li>
          <Link href="/admin/formats" className={`nav-link text-white ${isActive("/admin/formats") ? "active" : ""}`}>
        ...
        <li>
          <Link
            ...
            className={`nav-link text-white ${isActive("/admin/attributes") ? "active" : ""}`}
          >
