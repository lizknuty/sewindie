...
export default async function PatternsPage({ searchParams }: PageProps) {
  ...
  const page = Number.parseInt(typeof resolvedSearchParams.page === "string" ? resolvedSearchParams.page : "1", 10)
  const perPage = Number.parseInt(
    typeof resolvedSearchParams.perPage === "string" ? resolvedSearchParams.perPage : "40",
    10,
  )
  ...
  try {
    ...
    const [patterns, categories, attributes, formats, audiences, fabricTypes, designers, totalPatterns] =
      await Promise.all([
