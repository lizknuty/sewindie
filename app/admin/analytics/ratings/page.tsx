...
export default async function RatingsAnalyticsPage() {
  ...
  const chartData = Array.from({ length: 5 }, (_, i) => {
    ...
    const count = ratingCounts.find((r) => r.value === ratingValue)?._count.value || 0
    return {
      rating: ratingValue,
      count: count,
    }
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Ratings Analytics</h1>
        ...
        <div className="col-md-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Number of ratings for each star value (1-5).</CardDescription>
            </CardHeader>
            <CardContent>
              {chartData.every((data) => data.count === 0) ? (
                ...
                <ResponsiveContainer width="100%" height={300}>
                  ...
                  >
                    ...
                    <YAxis
                      allowDecimals={false}
                      label={{ value: "Number of Ratings", angle: -90, position: "insideLeft" }}
                    />
                    <Tooltip />
